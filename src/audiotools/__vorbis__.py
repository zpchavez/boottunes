...
from audiotools import AudioFile,InvalidFile,PCMReader,ReorderedPCMReader,construct,transfer_data,transfer_framelist_data,subprocess,BIN,cStringIO,open_files,os,ReplayGain,ignore_sigint,EncodingError,DecodingError,ChannelMask,UnsupportedChannelMask
...
class OggStreamReader:
    OGGS = construct.Struct(
        "oggs",
        construct.Const(construct.String("magic_number",4),"OggS"),
        construct.Byte("version"),
        construct.Byte("header_type"),
...
class OggStreamWriter:
    ...
    def build_pages(cls, granule_position, serial_number,
        ...
        page = construct.Container(magic_number = 'OggS',
                             version = 0,
...
class VorbisAudio(AudioFile):
    ...
    OGG_IDENTIFICATION = construct.Struct(
        "ogg_id",
        construct.ULInt32("vorbis_version"),
        construct.Byte("channels"),
        ...
        construct.Embed(construct.BitStruct("flags",
                                construct.Bits("blocksize_0",
                                         4),
                                construct.Bits("blocksize_1",
                                         4))),
    ...
    def set_metadata(self, metadata):
        ...
        for (page,data) in OggStreamWriter.build_pages(
            ...
            VorbisAudio.COMMENT_HEADER.build(construct.Container(
                    packet_type=3,
